...
class WeightSoftmaxCrossEntropy(function.Function):
...
def weight_softmax_cross_entropy(
        x, t, w=None, use_cudnn=True, normalize=True, cache_score=True):
    """Computes cross entropy loss for pre-softmax activations with weight.
    ...
    Args:
        ...
        w (Variable): Variable holding a float vector of weights.
    ...
    """
    return WeightSoftmaxCrossEntropy(use_cudnn, normalize, cache_score)(x, t, w)
